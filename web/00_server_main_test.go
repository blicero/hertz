// /home/krylon/go/src/github.com/blicero/hertz/web/00_database_main_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 05. 06. 2024 by Benjamin Walkenhorst
// (c) 2024 Benjamin Walkenhorst
// Time-stamp: <2026-06-03 11:08:28 krylon>
...
var (
	...
	addr     string
	client   http.Client
	testPort uint16 = common.WebPort + 2
)
...
func TestMain(m *testing.M) {
	var (
		...
		baseDir = time.Now().Format("/tmp/hertz_web_test_20060102_150405")
	)
